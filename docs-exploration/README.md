...
- [runbooks/deploy-gcp.md](runbooks/deploy-gcp.md) *(Sept 23, 2026)* — Upgraded & verified: Comprehensive guide to provisioning a GKE cluster, installing Agent Substrate from source, and deploying AX components on GCP GKE/GCS infrastructure.
