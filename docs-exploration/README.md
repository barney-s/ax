...
- [runbook-deployments/instance2/receipt-20260924-0432-teardown.md](runbook-deployments/instance2/receipt-20260924-0432-teardown.md) *(Sept 24, 2026)* — Teardown receipt for `instance2`, verifying complete deletion and zero remaining GCP resources (GKE cluster, GCS snapshot bucket, container images, and service account).
...
- [runbook-deployments/instance1/receipt-20260924-0045.md](runbook-deployments/instance1/receipt-20260924-0045.md) *(Sept 24, 2026)* — Execution receipt for the `instance1` deployment instance on GCP GKE, utilizing dynamic protobuf `protowire` field-injection, upgrading Substrate to 0.0.12, and creating extra cluster-scoped RBAC roles to unblock the API server and workers.
...
- [runbooks/deploy-gcp.md](runbooks/deploy-gcp.md) *(Sept 24, 2026)* — Upgraded & verified: Comprehensive guide to provisioning a GKE cluster, compiling and installing Agent Substrate from source, and deploying AX components on GCP GKE/GCS infrastructure.
- [runbooks/deploy-gcp-md.md](runbooks/deploy-gcp-md.md) *(Sept 24, 2026)* — Upgraded & verified: Comprehensive guide to provisioning a GKE cluster, compiling and installing Agent Substrate from source, and deploying AX components on GCP GKE/GCS infrastructure.
